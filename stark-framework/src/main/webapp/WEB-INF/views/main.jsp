...
<html><head>
    <meta charset="utf-8">
    <title>STARK - Dashboard Theme</title>
	...
	<script type="text/javascript" src="./resources/js/lineandbars.js"></script>
    
	<script type="text/javascript" src="./resources/js/dash-charts.js"></script>
	<script type="text/javascript" src="./resources/js/gauge.js"></script>
	...
	<script type="text/javascript" src="./resources/js/noty/layouts/topCenter.js"></script>
  ...
  <body>
    ...
    <div class="navbar-nav navbar-inverse navbar-fixed-top">
        ...
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.html"><img src="./resources/images/logo30.png" alt=""> STARK Dashboard</a>
        </div> 
    ...
    <div class="container">
      ...
      <!-- USER PROFILE BLOCK -->
        <div class="col-sm-3 col-lg-3">
      		<div class="dash-unit">
	      		...
	      		<hr>
				<div class="thumbnail">
					<img src="./resources/images/stark80x80.png" alt="Steel Stark" class="img-circle">
				</div><!-- /thumbnail -->
				<h1>Steel Stark</h1>
				<h3>Seoul, Korea</h3>
				<br>
      		...
      		<div class="framemail">
    			<div class="window">
			        <ul class="mail">
			            <li>
			                <i class="unread"></i>
			                <img class="avatar" src="./resources/images/photo01.jpeg" alt="avatar">
			            ...
			            <li>
			                <i class="read"></i>
			                <img class="avatar" src="./resources/images/photo02.jpg" alt="avatar">
			            ...
			            <li>
			                <i class="read"></i>
			                <img class="avatar" src="./resources/images/photo03.jpg" alt="avatar">
			            ...
			            <li>
			                <i class="read"></i>
			                <img class="avatar" src="./resources/images/photo04.jpg" alt="avatar">
	  ...
	  <!-- LAST MONTH REVENUE -->     
        <div class="col-sm-3 col-lg-3">
      		<div class="dash-unit">
	      		<dtitle>Today Board</dtitle>
	      		<hr>
	      		<div class="cont">
					<p><bold>$11,232</bold> | <ok>High</ok></p>
					<br>
					<p><bold>$377</bold> | Current</p>
					<br>
					<p><bold>$10,373</bold> | <bad>Low</bad></p>
					<br>
					<p><img src="./resources/images/down-small.png" alt=""> 8%</p>
        ...
        <div class="col-sm-3 col-lg-3">
      		<div class="dash-unit">
	            ...
	            <div class="flexslider">
					<ul class="slides">
						<li><img src="./resources/images/slide01.png" alt="slider"></li>
						<li><img src="./resources/images/slide02.png" alt="slider"></li>
					</ul>
            </div>
				<div class="cont">
      ...
      <!-- SERVER UPTIME -->
			<div class="half-unit">
	      		...
	      		<hr>
	      		<div class="cont">
					<p><img src="./resources/images/up.png" alt=""> <bold>Up</bold> | 356ms.</p>
				</div>
			</div>
	...
	<div class="row">
	  ...
	  <!-- LIVE VISITORS BLOCK -->     
      		<div class="half-unit">
	      		...
	      		<div class="cont">
      			<p><bold>388</bold></p>
      			<p><img src="./resources/images/up-small.png" alt=""> 412 Max. | <img src="./resources/images/down-small.png" alt=""> 89 Min.</p>
	      		</div>
      		</div>
	  ...
	  <!-- PAGE VIEWS BLOCK -->     
      		<div class="half-unit">
      			...
      			<p><img src="./resources/images/up-small.png" alt=""> 23.88%</p>
	      		</div>
      		</div>
      	</div>
	  ...
	  <!-- GAUGE CHART BLOCK -->     
 	  ...
 	  <!-- ACCORDION BLOCK -->     
			...
			<div class="col-sm-3 col-lg-3">
				...
				<br>
				<div class="text">
				<p>STARK Dashboard created by Steel Stark.</p>
				<p>Welcome to Stark Labs</p>
				</div>
	...
	<div id="footerwrap">
      	...
      	<div class="container">
      		<div class="row">
      			...
      			<p><img src="./resources/images/logo.png" alt=""></p>
      			<p>STARK Dashboard - Copyright 2019</p>
      			</div>
